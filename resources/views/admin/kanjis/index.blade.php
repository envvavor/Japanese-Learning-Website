                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 text-center bg-gray-50 dark:bg-gray-800/50">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-600 dark:text-gray-300 font-semibold mb-1 text-lg">Belum ada data kanji</p>
                                <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">Tambahkan data kanji pertama Anda sekarang.</p>
                                <a href="{{ route('admin.kanjis.create') }}" class="bg-white dark:bg-gray-700 border border-indigo-200 dark:border-indigo-700 text-indigo-600 dark:text-indigo-400 px-4 py-2 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/30 font-medium transition-colors">
