...
@section('title', 'Buat Folder Kosakata')
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
    <h3 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-6">Buat Folder Kosakata Baru</h3>

    <form method="POST" action="{{ route('admin.vocabulary-folders.store') }}">
        @csrf
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name" value="{{ old('name') }}" required
                   ...
                   placeholder="Contoh: JLPT N5 Dasar">
        ...
        <div class="mb-5">
            ...
            <textarea name="description" rows="3"
                      class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors resize-none"
                      placeholder="Deskripsi singkat...">{{ old('description') }}</textarea>
        </div>

        <div class="mb-6" x-data="{ selected: '{{ old('color', 'indigo') }}' }">
